...
namespace RocaTest
{
    class Program
    {
        static string pemCert = @"-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----";
        ...
        {
            if (TestCert(pemCert))
                Console.WriteLine("Certificate contains RSA public key vulnerable to ROCA (CVE-2017-15361)");
            else
                Console.WriteLine("Certificate does not contain RSA public key vulnerable to ROCA (CVE-2017-15361)");
        }
